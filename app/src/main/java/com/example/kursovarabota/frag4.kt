...
class frag4 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tvOcenka = view.findViewById<TextView>(R.id.textView6)
        ...
        rating.setOnRatingBarChangeListener { ratingBar, fl, b ->
            val ocenka = rating.rating
            tvOcenka.text = ocenka.toString()
        }

        val cv=view.findViewById<CalendarView>(R.id.calendarView)
        cv.setVisibility(View.INVISIBLE)

        view.findViewById<EditText>(R.id.editTextDate).setOnFocusChangeListener { view, b ->
            cv.isVisible=true
        }
