 ...
 * Use the [frag_place_3.newInstance] factory method to
 * create an instance of this fragment.
 */
class frag_place_3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_frag_place_3, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        resources.assets.open("photo.txt").use { fp ->
    ...
    companion object {
         ...
         * @return A new instance of fragment frag_place_3.
         */
